package com.common.widgets.recyclerview;
...
public abstract class FlexibleDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    protected int lastDividerCount = 1;
    ...
    protected FlexibleDividerDecoration(Builder builder) {
        ...
        lastDividerCount = builder.lastDeviderCount;
    }
        ...
        if (mSizeProvider == null) {
            mSizeProvider = new SizeProvider() {
                ...
                public int dividerSize(int position, RecyclerView parent) {
                    return (int) (parent.getContext().getResources().getDisplayMetrics().density*0.5+0.5);
                }
            };
        }
    }
    ...
    private boolean hasVerticalDivider(RecyclerView parent, int position) {
        ...
        if (parent.getLayoutManager() instanceof GridLayoutManager) {
            ...
            if (((LinearLayoutManager) parent.getLayoutManager()).getReverseLayout()) {
                ...
                return position < itemCount - lastDividerCount;
            }
        }
        return false;
    }
    ...
    public static class Builder<T extends Builder> {
        ...
        private int lastDeviderCount = 1;

        public Builder(Context context) {
            mContext = context;
            mResources = context.getResources();
        }
        public T lastDeviderCount(int count) {
            if (count >= 1) {
                lastDeviderCount = count;
            }
            return (T)this;
        }
